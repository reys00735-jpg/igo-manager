...
export default function ActionPlan() {
  ...
  const savePlan = async () => {
    ...
    try {
      ...
      console.log('DATOS PLAN:', payload);

      const plan = await createUserActionPlan(payload);

      console.log('RESULTADO PLAN:', plan);
    ...
    <ScrollView contentContainerStyle={styles.container}>
      <View style={styles.card}>
        ...
        <Text style={styles.title}>
          Convierte prioridades en ejecución
        </Text>

        <Text style={styles.subtitle}>
          Define fechas, presupuesto, responsables y estado para llevar la idea
          hacia adelante.
        </Text>
        ...
        <TextInput
          style={styles.input}
          placeholder="Aliados / responsables"
          value={allies}
